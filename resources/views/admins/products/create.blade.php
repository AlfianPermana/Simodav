        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="row row-cards">
                    <div class="col-12">
                        <form action="{{ route('admins.products.store') }}" enctype="multipart/form-data" method="POST"
                            class="card">
                            @csrf
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <textarea id="description" name="description" type="text"
                                                    ...
                                                    aria-describedby="descriptionHelp" placeholder="Deskripsi Produk" value="{{ old('description') }}" autofocus
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col">
                                                <input id="price" name="price" type="number"
                                                    ...
                                                    aria-describedby="priceHelp" placeholder="Harga Produk" />
                                                <small class="form-hint">
